...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var __css =
      ...
      '.dsh-import-card{background:var(--ds-color-card,#1f2330);border:1px solid rgba(255,255,255,.09);border-radius:14px;width:min(640px,92vw);max-height:82vh;display:flex;flex-direction:column;box-shadow:0 18px 60px rgba(0,0,0,.5)}' +
      '.dsh-import-head{padding:16px 20px 10px;border-bottom:1px solid rgba(255,255,255,.07)}' +
      ...
      '.dsh-import-src{border:1px solid rgba(255,255,255,.09);border-radius:10px;margin:8px 0;overflow:hidden;transition:opacity .18s,border-color .18s}' +
      ...
      '.dsh-import-src-head:hover{background:rgba(255,255,255,.04)}' +
      '.dsh-import-src-body{padding:2px 14px 12px;border-top:1px dashed rgba(255,255,255,.08)}' +
      ...
      '.dsh-import-foot{display:flex;justify-content:flex-end;gap:10px;padding:12px 20px;border-top:1px solid rgba(255,255,255,.07)}' +
      '.dsh-import-btn{border-radius:8px;border:1px solid rgba(255,255,255,.14);background:rgba(255,255,255,.05);color:inherit;padding:7px 16px;font-size:13px;cursor:pointer}' +
      ...
      /* 开关 */
      '.dsh-import-switch{position:relative;width:38px;height:21px;flex:none;cursor:pointer;border:0;background:rgba(255,255,255,.16);border-radius:12px;transition:background .18s;padding:0}' +
    ...
    function ImportRow() {
      ...
      return React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 10, padding: '10px 0', borderBottom: '1px solid rgba(255,255,255,.06)' } },
